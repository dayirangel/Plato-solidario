...
- [`PlatoSolidario_SOFT.pdf`](./PlatoSolidario_SOFT.docx) — Documentación completa del proyecto: SRS, SAD, diseño, diccionario de datos, plan de pruebas y bibliografía.
